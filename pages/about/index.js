...
const aboutData = [
  ...
  
  {
    ...
    info: [
      {
        title: "Software Developer - IDT Coorporation",
        stage: "2021 - present",
      },
      {
        title: "CRM developer - Marmotech",
        stage: "2022 - 2023",
      },
      {
  ...
  },
  {
    ...
    info: [
      {
        title: "Applied Technoglogies - Brigham Young University Idaho",
        stage: "present",
      },
      // {
    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row">
        <div className="flex-1 flex-col justify-center">
          ...
          >
            I am an experienced software developer with a strong track record of
            over 3 years in the industry. Throughout my career, I have
            successfully developed web applications, mobile applications, and
            CRM systems. My passion for coding drives me to deliver efficient
            and user-friendly solutions. I thrive on challenges and continuously
            seek opportunities to grow and innovate in the ever-evolving tech
          ...
          >
            <div className="flex flex-1 xl:gap-x-6">
              ...
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
                  <CountUp start={0} end={5038} duration={5} />+
                </div>
                <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">
