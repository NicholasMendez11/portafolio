  ...
  return (
    <div className="bg-primary/60 h-screen w-screen mt-10 lg:mt-0 overflow-hidden leading-relaxed">
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        ...
        {/* Avatar */}
        <motion.div variants={fadeIn('up',0.5)} initial="hidden" animate="show" exit="hidden" transition={{duration: 1, ease: 'easeInOut'}} className="w-full h-full max-w-[537px] max-h-[478px] absolute -bottom-32 lg:bottom-0 lg:right-[8%]">
          <Avatar/>
        </motion.div>
