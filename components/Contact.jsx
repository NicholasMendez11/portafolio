          ...
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400  dark:shadow-gray-900 rounded-xl lg:p-4">
            <div className="p-4">
              <form>
                ...
                <button className="w-full p-4 mt-5 text-gray-100 shadow-xl shadow-gray-400  dark:shadow-gray-900 rounded-xl uppercase bg-gradient-to-r from-[#089ec0] to-[#3a7bd5]">
                  Send Message
                </button>
              </form>
            </div>
